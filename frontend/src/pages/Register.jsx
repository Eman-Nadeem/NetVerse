...
import { User, Mail, Lock, ArrowRight, Eye, EyeClosed } from 'lucide-react';
...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      login(token, user);
      toast.success(`Welcome to NetVerse, ${user.name}!`);
      navigate('/');
    } catch (error) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-slate-50 dark:bg-zinc-950">
      <div className="w-full max-w-md bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-slate-200 dark:border-zinc-800 p-8 animate-fade-in-up">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold bg-linear-to-r from-indigo-600 to-purple-500 bg-clip-text text-transparent mb-2">
            Join NetVerse
          </h1>
          <p className="text-slate-500 dark:text-zinc-400">Create your account to connect</p>
        </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg py-2.5 pl-10 pr-4 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all"
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 rounded-lg py-2.5 pl-10 pr-10 focus:ring-2 focus:ring-indigo-500 focus:outline-none transition-all"
                placeholder="••••••••"
                required
              />
              <button
